...
export default function CreateThread() {
  ...
  const postThread = async () => {
    ...
    if (!attachedImg && !thread.content) return toast.error("Content is a required field.");
        ...
        <div className='create-thread-container-content'>
          <div className='create-thread-left-side'>
            ...
            <div className='create-thread-type'>
              <nav>
                <span
                  className={selected === "post" ? "create-thread-nav-active" : ""}
                  onClick={() => handleThreadTypeNav("post")}
                >
                  Post
                </span>
                <span
                  className={selected === "image" ? "create-thread-nav-active" : ""}
                  onClick={() => handleThreadTypeNav("image")}
                >
                  Image
                </span>
                <span
                  className={selected === "url" ? "create-thread-nav-active" : ""}
              ...
              <button
                ...
                onClick={() => (userData.blocked === false ? postThread() : isBlocked())}
              >
                Create Thread
              </button>
            </div>
          ...
          <div className='create-thread-right-side'>
            ...
            <ol>
              <li>
                Conversate thoughtfully and considerately. Neither hatred nor discrimination will be
                tolerated.
              </li>
              <br />
              ...
              <br />
              <li>
                Respect others&apos; privacy. Threat others the way you&apos;d like to be treated.
              </li>
              <br />
              <li>
                Avoid indecent language - although we strongly advocate for displaying your good
                sense of humor, please don&apos;t take it too far.
              </li>
              <br />
              <li>Have fun!</li>
            </ol>
